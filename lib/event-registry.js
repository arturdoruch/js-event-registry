...
export default {
     ...
     *
     * @param {string} events The event or events names separated by a coma.
     * @param {jQuery|HTMLElement|string|[]} element The jQuery or HTMLElement object, CSS selector,
     *                                               or array with mentioned elements.
...
function prepareEvent(events, element, listener, listenerArgs, listenerContext, preventDefault) {
    if (typeof listener !== 'function') {
        throw new TypeError(`The "listener" argument must be a function, but got "${typeof listener}".`);
    }
